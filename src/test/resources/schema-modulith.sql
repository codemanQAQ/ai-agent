...
CREATE TABLE IF NOT EXISTS agent_session_state (
    ...
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT uq_agent_session_state_user_conv UNIQUE (user_id, conversation_id)
);

CREATE INDEX IF NOT EXISTS idx_agent_session_state_user_conv
    ON agent_session_state(user_id, conversation_id);

CREATE TABLE IF NOT EXISTS public.pending_order_actions (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    user_id VARCHAR(255) NOT NULL,
    conversation_id VARCHAR(255) NOT NULL,
    cart_snapshot CLOB NOT NULL DEFAULT '{}',
    cart_snapshot_hash VARCHAR(128),
    address_snapshot CLOB NOT NULL DEFAULT '{}',
...
CREATE TABLE IF NOT EXISTS public.mock_orders (
    ...
    user_id VARCHAR(255) NOT NULL,
    conversation_id VARCHAR(255) NOT NULL,
    items_json CLOB NOT NULL DEFAULT '{}',
    address_json CLOB NOT NULL DEFAULT '{}',
